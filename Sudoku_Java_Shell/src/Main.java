	...
	public static void main ( String[] args )
	{
		...
		if ( file == "" )
		{
			...
			//	System.out.println( "Backtracks: " + trail.getUndoCount() );
				System.out.println("PASS : "+ (durationInNano/1000)+ ":");
				//System.out.println(durationInNano/1000);
			}
			else
			{
				System.out.println("FAIL");
			//	//System.out.println( "Failed to find a solution: 0" );
			}
		...
		if ( solver.hasSolution() )
		{
			...
			//System.out.println( "Trail Pushes: " + trail.getPushCount() );
			//System.out.println( "Backtracks: " + trail.getUndoCount() );
			System.out.print("PASS : "+ (durationInNano/1000)+":"); 
			//System.out.println(durationInNano/1000);	
		}
		else
		{
			System.out.print( "Failed to find a solution : 0 : " );
		}
	}
}
